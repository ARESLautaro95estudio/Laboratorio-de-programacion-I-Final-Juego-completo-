...
class FormMenu_03(Form):
    ...
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,image_background_form,active):
        ...
        self.back =Button(master=self,x=0,y=40,w=140,h=50,color_background=None,color_border=None,image_background="set_gui_01/Comic_Border/Elements/Element03s.png", on_click = self.back_boton ,on_click_param="Opciones",text="Back ",font="Castellar",font_size=25,font_color=RED)   
    ...
    def back_boton(self,parametro):
        ...
        self.forms_dict.pop("High score")
    ...
    def update(self, lista_eventos=[],keys=[],delta_ms=0,screen=[]):
    ...
    def highscor_top3(self):
        ...
        top_3 = readRows("nivel_uno") + readRows("nivel_dos") + readRows("nivel_tres")
