...
class Player:
    ...
    def update(self,delta_ms,lista_plataformas,lista_muros,lista_techos,lista_balas,lista_enemigos,lista_loot,lista_trampas):
        self.tiempo_transcurrido += delta_ms
        if self.tiempo_transcurrido > self.frame_rate_ms:
            ...
            self.colition(lista_trampas,delta_ms)
