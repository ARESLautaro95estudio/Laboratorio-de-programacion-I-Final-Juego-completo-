...
class Fruit:
    ...
    def __init__(self,x,y,w,h,type=0):
        ...
        self.stay = Auxiliar.getSurfaceFromSpriteSheet("mas_recursos/PIXEL ADVENTURE/PIXEL ADVENTURE/Recursos/Items/Fruits/Bananas.png",17,1,scale=1.4)[:]
        self.desapere = Auxiliar.getSurfaceFromSpriteSheet("mas_recursos/PIXEL ADVENTURE/PIXEL ADVENTURE/Recursos/Items/Fruits/Collected.png",6,1,scale=1)
        self.frame = 0
        self.animation=self.stay
        self.image = self.animation[self.frame]
        self.live = True
